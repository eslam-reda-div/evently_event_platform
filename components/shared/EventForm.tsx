...
const EventForm = ({ userId, type, event, eventId }: EventFormProps) => {
	...
	return (
		<Form {...form}>
			<form className='flex flex-col gap-5 space-y-8' onSubmit={form.handleSubmit(onSubmit)}>
						...
						render={({ field }) => (
							<FormItem className="w-full">
								<FormControl className="h-72">
									<Textarea placeholder="Description" {...field} className=" textarea rounded-md" />
								</FormControl>
								<FormMessage />
							</FormItem>
						)}
				...
				<div className="flex flex-col gap-5 md:flex-row">
					<FormField
						...
						render={({ field }) => (
							<FormItem className="w-full">
								<FormControl>
									<div className="flex-center h-[54px] w-full overflow-hidden rounded-md bg-[#f6f6f6] px-4 py-2">
				...
				<div className="flex flex-col gap-5 md:flex-row">
					<FormField
						...
						render={({ field }) => (
							<FormItem className="w-full">
								<FormControl>
									<div className=" grayscale flex-center h-[54px] w-full rounded-md bg-[#f6f6f6] px-4 py-2">
										...
										<DatePicker wrapperClassName="datePicker" dateFormat="MM/dd/yyyy h:mm aa" timeInputLabel="Time:" showTimeSelect selected={field.value} onChange={(date: Date) => field.onChange(date)} />
									</div>
								</FormControl>  
								<FormMessage />
							</FormItem>
